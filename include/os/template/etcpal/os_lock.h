...
/*int is a placeholder you should replace it with an actual mutex*/
typedef int etcpal_mutex_t;

/*these inline functions might need to become actual functions depending on implementation*/
#define etcpal_mutex_create(idptr) ((idptr == 0) ? true : false)
#define etcpal_mutex_take(idptr) ((idptr == 0) ? true : false)
#define etcpal_mutex_try_take(idptr) ((idptr == 0) ? true : false)
#define etcpal_mutex_give(idptr) (-1)
#define etcpal_mutex_destroy(idptr) (-1)
